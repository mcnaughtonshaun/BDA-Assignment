...
```{r, eval = TRUE, results="hide", warning=FALSE, cache=TRUE, fig.width = 6, fig.height= 12 , fig.align='center'}
par(mfrow=(c(3,1)))
...
```{r, eval = TRUE, include=TRUE, fig.width = 4, fig.height= 10 , fig.align='center'}
